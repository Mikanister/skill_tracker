...
/**
 * Options for {@link useSkillTreeState}, passing integration utilities (undo manager, etc.).
 */
...
/**
 * Public API returned from {@link useSkillTreeState} to manage skill tree CRUD and profile switching.
 */
...
/**
 * Manages skill tree state, persistence, profiles, and undo stack integration for skills/categories.
 */
