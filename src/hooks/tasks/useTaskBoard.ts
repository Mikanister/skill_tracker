...
/**
 * Configuration for {@link useTaskBoard}, wiring task data and status mutation callbacks.
 */
...
/**
 * Provides board-level state (filters, drag and drop helpers, selection) for the task board UI.
 */
